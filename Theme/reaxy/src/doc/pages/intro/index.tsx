...
import { MeetingRoomIcon } from "@config/assets";
    ...
    >
      ...
      <Box sx={{ position: "relative", p: "24px 0" }}>
        <Typography component={"li"} variant="h6">
          {t("created", { ns: "intro" as string })}
        </Typography>
        <Typography component={"li"} variant="h6">
          {t("by", { ns: "intro" as string })}
        </Typography>
        <Typography component={"li"} variant="h6">
          {t("email", { ns: "intro" as string })}
        </Typography>
      </Box>
      <Box sx={{ position: "relative", p: "24px 0" }}>
        <Typography
        ...
        >
          {t("hello", { ns: "intro" as string })}
        </Typography>
      </Box>
      <Box sx={{ position: "relative", p: "24px 0" }}>
        <Typography component={"li"} variant="h6">
          {t("text", { ns: "intro" as string })}
        </Typography>
      </Box>
    </LayoutBox>
  );
